...
md = st.markdown("""
    ...
    - [ ] 파일 업로드 및 채팅 기록을 구현합니다.
        > - [ ] 파일 업로드를 구현하기 위해 st.file_uploader를 사용합니다. type 매개변수를 통해 허용할 파일 확장자를 지정할 수 있습니다. [st.file_uploader 공식 문서](https://docs.streamlit.io/library/api-reference/widgets/st.file_uploader)
        > - [ ] 채팅 기록을 저장하기 위해 Session State를 사용합니다. [Session State 공식 문서](https://docs.streamlit.io/library/api-reference/session-state)
    ...
    - [ ] 다음 단계를 따르세요: [https://docs.streamlit.io/streamlit-community-cloud/deploy-your-app#deploy-your-app-1](https://docs.streamlit.io/streamlit-community-cloud/deploy-your-app#deploy-your-app-1)
